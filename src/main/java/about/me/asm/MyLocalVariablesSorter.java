...
public class MyLocalVariablesSorter extends MethodVisitor {
    ...
    /**
     * Creates a new {@link MyLocalVariablesSorter}. <i>Subclasses must not use
     * this constructor</i>. Instead, they must use the
     * {@link #MyLocalVariablesSorter(int, int, String, MethodVisitor)} version.
     *
     * @param access
     ...
     */
    public MyLocalVariablesSorter(final int access, final String desc,
                                   final MethodVisitor mv) {
        this(Opcodes.ASM5, access, desc, mv);
        if (getClass() != MyLocalVariablesSorter.class) {
            throw new IllegalStateException();
        }
    }

    /**
     * Creates a new {@link MyLocalVariablesSorter}.
     *
     * @param api
     ...
     *            the method visitor to which this adapter delegates calls.
     */
    protected MyLocalVariablesSorter(final int api, final int access,
